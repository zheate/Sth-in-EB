...
def material_manager():
    ...
    ri_state = st.session_state.setdefault("na_ri_state", {"wavelength_nm": 976.0})
    ...
    if ri_root is None:
        ...
        if st.button("📥 导入折射率到材料库", use_container_width=True, key="na_ri_import"):
